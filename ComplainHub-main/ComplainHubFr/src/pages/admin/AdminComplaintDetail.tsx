          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 text-sm text-muted-foreground mb-4">
                ...
                >
                  {complaint?.priority ? (complaint.priority.charAt(0).toUpperCase() + complaint.priority.slice(1)) : 'Unknown'} Priority
                </Badge>
              </div>
              <p className="text-muted-foreground mb-4">{complaint?.description || 'No description available.'}</p>
